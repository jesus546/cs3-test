...
import { setEditTaskState, setFilterState, setModalState, setTodoState, setUpdateTaskState, taskInitial, useModalState, useTaskEditState, useTodoState } from '@/store/todo/todoSlice'
                ...
                {({ field, form }: any) => (
                  <div className="flex items-start">
                    <div className="flex items-center h-5">
                      <input id="completed" checked={field.value} {...field} type="checkbox" value="" className="w-4 h-4 border border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-blue-300 dark:bg-gray-600 dark:border-gray-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 dark:focus:ring-offset-gray-800" />
                    </div>
